...
import mscbanner from "../../../assets/image/mscbanner.jpg";
        ...
        <div>
          ...
          <div className="absolute lg:top-52 lg:left-32 sm:top-40 sm:left-10 text-white text-2xl tracking-wide">
            {/* <h2 className="font-normal flex">
              ...
              <span> Detail Drawings & 3D Modelings</span>
            </h2> */}
            <p className="mt-10 lg:text-4xl sm:text-2xl font-bold ">
              Detail Drawings & 3D Modelings
            </p>
            <p className="text-white lg:w-[50%] mt-10 text-lg sm:hidden lg:block sm:hidden lg:block">
                            ...
                            <div>
                              <ul className=" space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                <li className="flex items-center">
                                  ...
                                  Preparation of Fabrication Drawings using AUTO
                                  CAD.
                                </li>
                                <li className="flex items-center">
                                  <svg
                                  ...
                                  Preparation of Fabrication Drawings using
                                  Tekla model.
                                </li>
                                <li className="flex items-center">
                                  <svg
                                  ...
                                  3D structural and piping modeling using PDMS
                                </li>
                                <li className="flex items-center">
                                  <svg
                                    className="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0"
