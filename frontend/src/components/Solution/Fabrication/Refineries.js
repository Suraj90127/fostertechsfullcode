...
import refineries from "../../../assets/image/refineries.webp";
    ...
    <div>
      ...
      <div>
        <div className=" bottom-0 w-full mt-20 bg-no-repeat careers">
          <img
            className="lg:h-[30rem] md:h-[20rem] sm:h-[13rem] w-full opacity-100"
            src={refineries}
            alt=""
          />
        </div>
        <div className="absolute lg:top-52 lg:left-32 sm:top-40 sm:left-10 text-white text-2xl tracking-wide">
          ...
          <p className="mt-10 lg:text-4xl sm:text-3xl font-bold ">
            {" "}
            Refineries:
          </p>
          <p className="text-white lg:w-[50%] mt-10 text-lg sm:hidden lg:block">
            Renewable energy offers multitudinous environmental, profitable, and
            social benefits, including reducing hothouse gas emigrations,
            mollifying climate change, enhancing energy security, creating jobs,
      ...
      <div className="flex flex-col items-center justify-center w-full py-10 gap-4 md:gap-6 lg:gap-8">
        <div className="md:flex lg:w-full flex-col gap-4 md:gap-6 lg:gap-8 lg:mx-10 sm:mx-5">
          ...
          {/*  Cements Plants: */}
          <div className="md:grid md:grid-cols-12 sm:flex sm:flex-col sm:justify-center sm:items-center sm:gap-6 lg:gap-10 xl:gap-14 md:px-5 lg:mx-20">
            <div className="lg:col-span-6 md:col-span-6 sm:col-span-12">
              <img
                className="lg:w-[30rem] lg:h-[30rem] sm:w-[20rem] sm:h-[20rem] rounded-full"
                src={servicedep1}
                alt=""
              />
            </div>
            <div className="lg:col-span-6 md:col-span-6 sm:col-span-12 sm:mt-10 lg:mt-16 ">
      ...
      <div>
        <section class=" lg:pt-[30px] bg-gray-100 mt-5">
          ...
          <div class="w-[90%] mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 py-10 gap-10">
