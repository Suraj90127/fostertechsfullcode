      ...
      <div>
        ...
        <div>
          <div className=" bottom-0 w-full mt-20 bg-no-repeat careers">
            <img
              className="lg:h-[30rem] sm:h-[13remb] w-full opacity-100"
              src={servicedep}
              alt=""
            />
          </div>
          <div className="absolute lg:top-52 lg:left-32 sm:top-40 sm:left-10 text-white text-2xl tracking-wide">
            ...
            <p className="mt-10 text-4xl font-bold ">Other industries:</p>
        ...
        <div className="flex flex-col items-center justify-center w-full py-10 gap-4 md:gap-6 lg:gap-8">
          <div className="lg:w-full md:flex flex-col gap-4 md:gap-6 lg:gap-8 lg:mx-10 sm:mx-5">
            <div className="text-center mb-10 ">
              <h2 className="lkg:text-5xl sm:text-3xl font-semibold text-[#243945]">
                Other industries:
              </h2>
            ...
            {/*  Cements Plants: */}
            <div className="lg:grid lg:grid-cols-12  items-start sm:gap-6 md:gap-5 lg:gap-10 xl:gap-14 md:px-5 lg:mx-20">
              ...
              <div className="lg:col-span-6 sm:col-span-12 sm:mt-10 lg:mt-16 ">
                <div className=" w-full">
                  ...
                  <ol class="list-decimal space-y-1 text-gray-500 list-inside dark:text-gray-400 mb-10">
                    <li>
                      Industrial sheds for water treatment plants, Factories and
                      slaughters house.
                    </li>
                    <li>Prefabricated sewage treatment plants</li>
                    <li>Garbage chutes for multistory buildings</li>
                  </ol>
                </div>
              </div>
            </div>
        ...
        <div>
          <section class=" lg:pt-[30px] bg-gray-100 mt-5">
            ...
            <div class="lg:w-[90%] lg:mx-20 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 py-10 gap-10">
