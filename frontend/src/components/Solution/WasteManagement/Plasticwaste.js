...
import plasticwaste2 from "../../../assets/image/plasticwaste2.png";
import wastebanner from "../../../assets/image/wastebanner.webp";
import plasticwastebanner from "../../../assets/image/plasticwastebanner.webp";
    ...
    <>
      <div>
        ...
        <div>
          <div className=" bottom-0 w-full mt-20 bg-no-repeat careers">
            <img
              ...
              src={plasticwastebanner}
              alt=""
            />
          </div>
          <div className="absolute lg:top-52 lg:left-32 sm:top-32 sm:left-8 text-white text-2xl tracking-wide">
            ...
            <p className="text-white lg:w-[50%] mt-10 text-lg sm:hidden lg:block">
              Plastic waste management - it is precise conversion of plastic
              waste into innovative products that are better and environmentally
              friendly
            </p>
            {/* <hr className="mt-10 " /> */}
          </div>
        ...
        <div className="lg:mt-20 mt-5">
          <div className="text-center lg:mx-32 sm:mx-5">
            <h2 className="lg:text-3xl sm:text-lg font-semibold text-[#243945]">
              Segregation Of Plastic Waste According To Plastic Waste Management
              Rules, 2018 And Amended Rules, 2021 Through Waste Pickers.
            </h2>
            <p className="text-lg my-5 text-gray-400 ">
              Classification Of Plastics Bureau Of Indian Standards (Bis)
              Classifies Plastic Into Seven Types.
            </p>
          </div>
          <div>
            <img className="w-full h-[30rem]" src={solidwaste180} alt="" />
          </div>
        </div>
        <div className="lg:mt-20 sm:mt-5">
          <div className="text-center lg:mx-32 sm:mx-5">
            <h2 className="lg:text-3xl sm:text-lg font-semibold text-[#243945] lg:mx-32">
          ...
          <div>
            <img className="w-full h-[30rem]" src={plasticwaste2} alt="" />
          </div>
        </div>
      </div>
    </>
