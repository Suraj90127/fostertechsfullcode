...
import solidwaste190 from "../../../assets/image/solidwaste190.png";
import waterwastebanner from "../../../assets/image/waterwastebanner.webp";
      ...
      <div>
        ...
        <div>
          ...
          <div className="absolute lg:top-52 lg:left-32 sm:top-32 sm:left-10 text-white text-2xl tracking-wide">
            ...
            <p className="text-white lg:w-[50%] mt-10 text-lg sm:hidden lg:block">
              Waste water management - it is also most essential approach to
              protect water resources and it is defined as collection,
        ...
        <div className="lg:flex ">
          <div className=" w-full ">
            <div className=" flex">
              <div className="w-[100%]  bg-white lg:my-10 sm:my-5">
                <div className="bg-white sm:grid-cols-1">
                  {/* Step 1st */}
                  <div className="flex flex-col items-center justify-center w-full lg:py-10 sm:py-3 gap-4 md:gap-6 lg:gap-8">
                      ...
                      <div className="">
                        <div className="text-center ">
                          <h2 className="lg:text-3xl sm:text-lg font-semibold text-[#243945]">
                            Leachate Treatment Plant And Sewer Treatment Plant
                          </h2>
